...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="md:rounded-b-lg bg-gray-100 mt-32">
        <div className="w-full py-10 grid grid-cols-1  md:grid-cols-3 xl:grid-cols-3 gap-5 md:gap-10 gap-x-40">
          ...
          <div className=" flex flex-col items-center">
            <h4 className="font-semibold text-xl xl:text-xl tracking-widest capitalize mb-3 text-mainclr ">
              Quick links
            </h4>
            <div className="text-sm tracking-wider flex flex-col gap-1  text-mainclr">
          ...
          <div className="flex flex-col items-center md:items-center md:pr-20 gap-1 text-mainclr text-center md:text-right">
        ...
        <div className="w-11/12 xl:w-10/12 py-5  border-t-2 text-mainclr border-[#ffffff43] mx-auto text-sm font-extralight  flex flex-col items-center md:items-start gap-y-5 justify-between md:flex-row gap-1">
